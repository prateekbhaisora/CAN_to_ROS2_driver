...
static const _HRCanDataFormat_type_support_symbol_names_t _HRCanDataFormat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver_interfaces, msg, HRCanDataFormat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver_interfaces, msg, HRCanDataFormat)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, driver_interfaces, msg, HRCanDataFormat)() {
  return &::driver_interfaces::msg::rosidl_typesupport_c::HRCanDataFormat_message_type_support_handle;
}
